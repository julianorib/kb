...
- **Segurança**:
    ...
    - SAS (assinatura de acesso compartilhado).\
      concede direitos de acesso stritos e por tempo limitado.
...
- **Tipos de Blob**:
    - Blob de Blocos - arquivos geral - padrão
    - Blob de Acréscimo - logs
    - Blob de página - discos (leitura/gravação)
...
- **Caamdas**:
    ...
    - Cold - min 90 dias
    - Archine - min 180 dias

- **Replicação**:
    - Necessita controle de versáo habilitado
...
- **Descrição**:
Serviço que armazena e analisa logs do Azure Monitor usando consultas Kusto Query Language (KQL).
